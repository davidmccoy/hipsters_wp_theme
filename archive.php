		...
		<div class="postarea">
            ...
            <div <?php post_class(); ?>>
	            ...
	            <div class="postauthor">
	        		<p><?php _e("Posted by", 'organicthemes'); ?> <?php the_author_posts_link(); ?> <?php _e("on", 'organicthemes'); ?> <?php the_time(__("F j, Y", 'organicthemes')); ?> <!-- &middot; <a href="<?php the_permalink(); ?>#comments"> --><!-- <fb:comments-count href="<?php echo get_permalink() ?>"></fb:comments-count> Comments</a> --></a>&nbsp;<?php edit_post_link(__("(Edit)", 'organicthemes'), '', ''); ?></p>
	            </div>
